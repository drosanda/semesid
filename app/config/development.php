 ...
 * @var string
 */
$site = "http://".$_SERVER['HTTP_HOST']."/semesid/";
/**
 * URL parse method
...
// example
$semevar['site_name'] = 'SemeSID';
$semevar['site_suffix'] = ' - Nama Desa';
$semevar['site_suffix_admin'] = ' - Admin Nama Desa';
$semevar['email_from'] = 'noreply@thecloudalert.com';
$semevar['email_reply'] = 'hi@thecloudalert.com';
$semevar['app_name'] = 'NamaDesa';
